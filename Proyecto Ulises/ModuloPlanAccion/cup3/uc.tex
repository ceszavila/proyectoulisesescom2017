\begin{UseCase}{CUP 3}{Modificar objetivo}
	{
		Este caso de uso permite al actor modificar un \cdtRef{gls:objetivo}{objetivo} cuando existen errores o actualizaciones en la información. 
		...
		validados y se realizará la actualización de la información.
	}
	\UCitem{Versión}{1.0}
	\UCccsection{Administración de Requerimientos}	
	\UCitem{Autor}{Natalia Giselle Hernández Sanchez}	
	\UCccitem{Evaluador}{}
...
% %--------------------------------------------------------
 	...
 	\UCccitem{Observaciones}{
 		\begin{UClist}
 			\RCitem{PC1}{\DONE{Postcondiciones: Cambiar registrará por se ->podrá registrar}}{No aplica}
 			\RCitem{PC2}{\DONE{Salidas: Liga rota en periodo}}{}
		\end{UClist}		
 	}
% %--------------------------------------------------------
	...
	\UCitem{Propósito}{Modificar un objetivo cuando se detectan errores o actualizaciones en la información.}
	\UCitem{Entradas}{
	  \begin{UClist}
	...
	\UCitem{Salidas}{
		\begin{UClist} 
			...
			\UCli \cdtRef{gls:lineaAccion}{Línea de acción}: \ioObtener. 
			\UCli \cdtRef{objetivo:objetivoGeneral}{Objetivo general}: \ioObtener.
	...
	\UCitem{Postcondiciones}{
		\begin{UClist}
 			\UCli {\bf Interna:} Se modificará el objetivo en el sistema.
		\end{UClist}
	}
	...
	\UCitem{Errores}{
		\begin{UClist}		
			\UCli \cdtIdRef{MSG4}{No se encontró información sustantiva}: Se muestra en la pantalla \cdtIdRef{IUP 1}{Administrar objetivos} cuando hace falta información referente a la línea de acción.
			\UCli \cdtIdRef{MSG5}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \cdtIdRef{IUP 3}{Modificar objetivo} cuando el actor no ingresó un dato requerido para realizar la operación.
 			\UCli \cdtIdRef{MSG7}{Se ha excedido la longitud máxima del campo}: Se muestra en la pantalla \cdtIdRef{IUP 3}{Modificar objetivo} cuando el actor escribió un dato que excede el tamaño especificado por el sistema.
 			...
 			\UCli \cdtIdRef{MSG33}{Unicidad de objetivos por línea de acción}: Se muestra en la pantalla \cdtIdRef{IUP 3}{Modificar objetivo} cuando el actor seleccionó una línea de acción que ya tiene asociado un objetivo.
...
\begin{UCtrayectoria}
	\UCpaso[\UCactor] Solicita modificar un objetivo oprimiendo el botón \botEdit del registro que desea modificar en la pantalla \cdtIdRef{IUP 1}{Administrar objetivos}.
	...
	\UCpaso[\UCsist] Muestra la información del objetivo en la pantalla \cdtIdRef{IUP 3}{Modificar objetivo}.
	\UCpaso[\UCactor] Ingresa los datos nuevos del objetivo en la pantalla \cdtIdRef{IUP 3}{Modificar objetivo}.\label{cup3:ingresarDatos} 
	\UCpaso[\UCactor] Solicita la modificación del objetivo oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{IUP 3}{Modificar objetivo}. \refTray{D}
	\UCpaso[\UCsist] Verifica que la escuela se encuentre en  estado ``Plan de acción en edición''. \refTray{A}.
	...
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación realizada exitosamente} en la pantalla \cdtIdRef{IUP 1}{Administrar objetivos} indicando que se ha realizado la modificación del objetivo satisfactoriamente.
\end{UCtrayectoria}
...
\begin{UCtrayectoriaA}[Fin del caso de uso]{D}{El actor desea cancelar la operación.}
	\UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \cdtButton{Cancelar} de la pantalla \cdtIdRef{IUP 3}{Modificar objetivo}.
...
\begin{UCtrayectoriaA}{E}{El actor no proporcionó alguno de los datos requeridos.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG5}{Falta un dato requerido para efectuar la operación solicitada} en la pantalla \cdtIdRef{IUP 3}{Modificar objetivo},
...
\begin{UCtrayectoriaA}{F}{El actor proporcionó un dato que excede la longitud máxima.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG7}{Se ha excedido la longitud máxima del campo} en la pantalla \cdtIdRef{IUP 3}{Modificar objetivo}
...
\begin{UCtrayectoriaA}{G}{Existe un objetivo asociado a la línea de acción seleccionada.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG33}{Unicidad de objetivos por línea de acción} en la pantalla \cdtIdRef{IUP 3}{Modificar objetivo}
