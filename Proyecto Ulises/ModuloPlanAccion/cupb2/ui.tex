\subsection{IUPB 2 Modificar meta de biodiversidad}
                     
\subsubsection{Objetivo}

   Esta pantalla permite al actor modificar una \cdtRef{gls:meta}{meta} de la línea de acción ``Biodiversidad'', cuando existen errores en la información o simplemente cuando esta se haya actualizado.
...
\subsubsection{Diseño}
  ...
  Si el actor selecciona que la meta no está enfocada a una capacitación y/o sensibilización, se mostrará la sección ``Cuantificar meta'' como se muestra en la pantalla ~\ref{IUPB 2.4}, el actor 
  deberá ingresar los datos referentes al valor a alcanzar.\\
 
  \IUfig[.9]{pantallas/planAccion/cupb1/iupb1}{IUPB 2}{Modificar meta de biodiversidad}
  \IUfig[.9]{pantallas/planAccion/cupb1/iupb1_1}{IUPB 2.1}{Modificar meta de biodiversidad: Incremento de áreas verdes}
  \IUfig[.9]{pantallas/planAccion/cupb1/iupb1_2}{IUPB 2.2}{Modificar meta de biodiversidad: Forestación y reforestación}
  \IUfig[.9]{pantallas/planAccion/cupb1/iupb1_3}{IUPB 2.3}{Modificar meta de biodiversidad: Capacitación y/o sensibilización}
  \IUfig[.9]{pantallas/planAccion/cupb1/iupb1_4}{IUPB 2.4}{Modificar meta de biodiversidad: Cuantificar meta}
...
\begin{description}
	...
	\item[\cdtIdRef{MSG5}{Falta un dato requerido para efectuar la operación solicitada}:] Se muestra en la pantalla \cdtIdRef{IUPB 2}{Modificar meta de biodiversidad} cuando el actor no ingresó un dato requerido para realizar la operación.
	\item[\cdtIdRef{MSG6}{Formato incorrecto}:] Se muestra en la pantalla \cdtIdRef{IUPB 2}{Modificar meta de biodiversidad} cuando el formato de alguno de los datos ingresados es incorrecto.
	\item[\cdtIdRef{MSG7}{Se ha excedido la longitud máxima del campo}:] Se muestra en la pantalla \cdtIdRef{IUPB 2}{Modificar meta de biodiversidad} cuando el actor escribió un dato que excede el tamaño especificado por el sistema.
