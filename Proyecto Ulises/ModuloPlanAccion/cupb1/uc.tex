\begin{UseCase}{CUPB 1}{Registrar meta de biodiversidad}
	{
		Este caso de uso permite al actor solicitar el registro de una \cdtRef{gls:meta}{meta} de la línea de acción ``Biodiversidad'',
...
% %--------------------------------------------------------
 	...
 	\UCccitem{Observaciones}{
 		\begin{UClist}
 			...
 			\RCitem{PC4}{\DONE{De la sección Cuantificar meta: Ligas de Unidad y Nueva unidad, rotas}}{}
 		\end{UClist}		
 	}
% %--------------------------------------------------------
% %--------------------------------------------------------
	...
	\UCitem{Propósito}{Registrar una meta asociada al objetivo de la línea de acción ``Biodiversidad''.}
...
\UCli {\bf Interna:} Que la escuela se encuentre en estado \cdtRef{estado:planEdicion}{Plan de acción en edición}.
	...
	\UCitem{Errores}{
		\begin{UClist}	
			...
			\UCli \cdtIdRef{MSG5}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad} cuando el actor no ingresó un dato requerido para realizar la operación.
			\UCli \cdtIdRef{MSG6}{Formato incorrecto}: Se muestra en la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad} cuando el formato de alguno de los datos ingresados es incorrecto.			
 			\UCli \cdtIdRef{MSG7}{Se ha excedido la longitud máxima del campo}: Se muestra en la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad} cuando el actor escribió un dato que excede el tamaño especificado por el sistema.
...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad} por medio de la cual se realizará el registro de la meta.
	\UCpaso[\UCactor] Ingresa los datos correspondientes a la sección ``Información de la meta'' de la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad}. \label{cupb1:ingresaDatos}
	\UCpaso[\UCactor] Selecciona que el \cdtRef{gls:enfoqueMeta}{enfoque de la meta} es ``Incremento de áreas verdes'' en la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad}. \refTray{D}
	\UCpaso[\UCsist] Busca la información referente a la superficie del predio.
	\UCpaso[\UCsist] Muestra los campos referentes al incremento de áreas verdes en la pantalla \cdtIdRef{IUPB 1.1}{Registrar meta de biodiversidad: Incremento de áreas verdes}
	\UCpaso[\UCactor] Ingresa los metros cuadrados a incrementar.
	\UCpaso[\UCactor] Solicita registrar la meta oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad}. \refTray{G}
	\UCpaso[\UCsist] Verifica que la escuela se encuentre en  estado ``Plan de acción en edición''. \refTray{A}.	
	...
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación realizada exitosamente} en la pantalla \cdtIdRef{IUP 5}{Administrar metas} indicando que se ha realizado el registro de la meta satisfactoriamente. \label{cupb1:muestraMensaje}
\end{UCtrayectoria}
...
\begin{UCtrayectoriaA}{D}{El actor selecciona que el enfoque de la meta no es ``Incremento de áreas verdes''.}
	...
	\UCpaso[\UCsist] Muestra la sección ``Información de la forestación y reforestación'' en la pantalla \cdtIdRef{IUPB 1.2}{Registrar meta de biodiversidad: Forestación y reforestación}.
	\UCpaso[\UCactor] Selecciona que el \cdtRef{gls:enfoqueMeta}{enfoque de la meta} es ``Plantación de árboles''. \refTray{C}
	\UCpaso[\UCactor] Ingresa el número de árboles a plantar en la pantalla \cdtIdRef{IUPB 1.2}{Registrar meta de biodiversidad: Forestación y reforestación}.
	\UCpaso[\UCactor] Solicita registrar la meta oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad}. \refTray{G} 
	\UCpaso[\UCsist] Verifica que los datos ingresados por el actor sean correctos como lo indica la regla de negocio \cdtIdRef{RN-S1}{Información correcta}. \refTray{H} \refTray{I} \refTray{J}
...
\begin{UCtrayectoriaA}{E}{El actor selecciona que el enfoque de la meta no es ``Plantación de árboles''.}
	...
	\UCpaso[\UCsist] Muestra la sección ``Información de la capacitación y/o sensibilización'' en la pantalla \cdtIdRef{IUPB 1.3}{Registrar meta de biodiversidad: Capacitación y/o sensibilización}.
	...
	\UCpaso[\UCactor] Ingresa los datos correspondientes a la sección ``Información de la capacitación y/o sensibilización'' de la pantalla \cdtIdRef{IUPB 1.3}{Registrar meta de biodiversidad: Capacitación y/o sensibilización}.
	\UCpaso[\UCactor] Solicita registrar la meta oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad}. \refTray{G} 
	\UCpaso[\UCsist] Verifica que los datos ingresados por el actor sean correctos como lo indica la regla de negocio \cdtIdRef{RN-S1}{Información correcta}. \refTray{H} \refTray{I} \refTray{J}
	\UCpaso[\UCsist] Registra la nueva meta en el sistema con enfoque ``Capacitación y/o sensibilización'' e incluye \cdtRef{capacitacionSensibilizacion:conceptoBiodiversidad}{la enseñanza del concepto biodiversidad}.
	\UCpaso[] Continúa en el paso \ref{cupb1:muestraMensaje} de la trayectoria principal.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{X}{El actor selecciona que el enfoque de la meta no es ``Capacitación y/o sensibilización''.}
	...
	\UCpaso[\UCsist] Muestra la sección ``Cuantificar meta'' en la pantalla \cdtIdRef{IUPB 1.4}{Registrar meta de biodiversidad: Cuantificar meta}.
	\UCpaso[\UCactor] Ingresa el valor y el nombre del valor a alcanzar en la sección ``Cuantificar meta'' de la pantalla \cdtIdRef{IUPB 1.4}{Registrar meta de biodiversidad: Cuantificar meta}.
	\UCpaso[\UCactor] Selecciona la unidad del valor a alcanzar en la sección ``Cuantificar meta'' de la pantalla \cdtIdRef{IUPB 1.4}{Registrar meta de biodiversidad: Cuantificar meta}. \refTray{F}
	\UCpaso[\UCactor] Solicita registrar la meta oprimiendo el botón \cdtButton{Aceptar} de la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad}. \refTray{G} 
	\UCpaso[\UCsist] Verifica que los datos ingresados por el actor sean correctos como lo indica la regla de negocio \cdtIdRef{RN-S1}{Información correcta}. \refTray{H} \refTray{I} \refTray{J}
...
\begin{UCtrayectoriaA}{F}{El actor selecciona la opción ``Otra'' como unidad del valor a alcanzar.}
	\UCpaso[\UCactor] Selecciona ``Otra'' como la unidad del valor a alcanzar en la sección ``Cuantificar meta'' de la pantalla \cdtIdRef{IUPB 1.4}{Registrar meta de biodiversidad: Cuantificar meta}.
	\UCpaso[\UCsist] Muestra la pantalla  \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad} con el campo ``Nueva unidad''.
...
\begin{UCtrayectoriaA}[Fin del caso de uso]{G}{El actor desea cancelar la operación.}
	\UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \cdtButton{Cancelar} de la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad}.
...
\begin{UCtrayectoriaA}{H}{El actor no proporcionó alguno de los datos requeridos.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG5}{Falta un dato requerido para efectuar la operación solicitada} en la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad},
...
\begin{UCtrayectoriaA}{I}{El actor proporcionó un dato que es incorrecto.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG6}{Formato incorrecto} en la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad}
...
\begin{UCtrayectoriaA}{G}{El actor proporcionó un dato que excede la longitud máxima.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG7}{Se ha excedido la longitud máxima del campo} en la pantalla \cdtIdRef{IUPB 1}{Registrar meta de biodiversidad}
