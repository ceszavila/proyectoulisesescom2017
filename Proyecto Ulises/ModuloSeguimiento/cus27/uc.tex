...
% %--------------------------------------------------------
    ...
    \UCitem{Propósito}{Registrar los avances de las acciones de una meta de residuos sólidos.}
    \UCitem{Entradas}{
	\begin{UClist}
	...
	\begin{UClist} 
	    ...
	    \UCli \cdtIdRef{MSG1}{Operación realizada exitosamente:} Se muestra en la pantalla \cdtIdRef{IUS 26}{Administrar avances de residuos sólidos} cuando el registro del avance para las acciones se ha realizado correctamente.
	\end{UClist}
    }
	...
	\begin{UClist}
	    ...
	    \UCli \cdtIdRef{MSG6}{Formato incorrecto}: Se muestra en la pantalla \cdtIdRef{IUS 27}{Registrar avance de acciones de residuos sólidos} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
	    
	    \UCli \cdtIdRef{MSG7}{Se ha excedido la longitud máxima del campo}: Se muestra en la pantalla \cdtIdRef{IUS 27}{Registrar avance de acciones de residuos sólidos} cuando se ha excedido la longitud de alguno de los campos.	
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Solicita registrar un avance en las acciones registradas para una meta oprimiendo el botón \botAutoAjus del registro correspondiente en la pantalla \cdtIdRef{IUS 26}{Administrar avances de residuos sólidos}.
    ...
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUS 27}{Registrar avance de acciones de residuos sólidos} con la información referente a las acciones de la meta. 
    \UCpaso[\UCactor] Ingresa los datos requeridos en la pantalla \cdtIdRef{IUS 27}{Registrar avance de acciones de residuos sólidos}. \label{cus27:RegAvanceAgua}
    \UCpaso[\UCactor] Oprime el botón \cdtButton{Aceptar} en la pantalla \cdtIdRef{IUS 27}{Registrar avance de acciones de residuos sólidos}. \refTray{C}. 
    \UCpaso[\UCsist] Verifica que la escuela se encuentre en estado ``Avance en edición''. \refTray{A}.
    \UCpaso[\UCsist] Verifica que la fecha actual se encuentre dentro del periodo definido por la SMAGEM para realizar la operación. \refTray{B}.
    ...
    \UCpaso[\UCsist] Calcula el avance acumulado para cada una de las acciones de la meta de residuos sólidos con base en la regla de negocio \cdtIdRef{RN-N16}{Calcular avance acumulado}.
 ...
 \end{UCtrayectoriaA}
    ...
    \begin{UCtrayectoriaA}[Fin del caso de uso]{C}{El actor desea cancelar la operación.}
      \UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \cdtButton{Cancelar} en la pantalla \cdtIdRef{IUS 27}{Registrar avance de acciones de residuos sólidos}.
      \UCpaso[] Regresa a la pantalla \cdtIdRef{IUS 26}{Administrar avances de residuos sólidos}. 
    \end{UCtrayectoriaA}
    
    \begin{UCtrayectoriaA}{D}{El actor ingresó un tipo de dato incorrecto.}    
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG6}{Formato incorrecto} en la pantalla \cdtIdRef{IUS 27}{Registrar avance de acciones de residuos sólidos} indicando que el registro del avance para la acción no puede realizarse debido a que la información ingresada no es correcta.
	...
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG7}{Se ha excedido la longitud máxima del campo} en la pantalla \cdtIdRef{IUS 27}{Registrar avance de acciones de residuos sólidos} indicando que el registro del avance de la acción de la meta de residuos sólidos no puede realizarse debido a que la longitud del campo excede la longitud máxima definida.
	\UCpaso[] Continúa con el paso \ref{cus27:RegAvanceAgua} de la trayectoria principal.     
    \end{UCtrayectoriaA}
