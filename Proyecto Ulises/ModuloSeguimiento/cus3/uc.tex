\begin{UseCase}{CUS 3}{Registrar avance de acciones de ambiente escolar}
    {
...
% %--------------------------------------------------------
    ...
    \begin{UClist}
        ...
        \UCli \cdtIdRef{MSG6}{Formato incorrecto}: Se muestra en la pantalla \cdtIdRef{IUS 3}{Registrar avance de acciones de ambiente escolar} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
        
        \UCli \cdtIdRef{MSG7}{Se ha excedido la longitud máxima del campo}: Se muestra en la pantalla \cdtIdRef{IUS 3}{Registrar avance de acciones de ambiente escolar} cuando se ha excedido la longitud de alguno de los campos.    
        
        \UCli \cdtIdRef{MSG28}{Operación no permitida por estado de la entidad}: Se muestra en la pantalla \cdtIdRef{IUS 2}{Administrar avances de ambiente escolar} indicando al actor que no se pueden registrar avances en las acciones de la meta de ambiente escolar debido al estado en que se encuentra el seguimiento.
    \end{UClist}
    }
...
\begin{UCtrayectoria}
    \UCpaso[\UCactor] Solicita registrar un avance en las acciones registradas para una meta oprimiendo el botón \botAutoAjus del registro correspondiente en la pantalla \cdtIdRef{IUS 2}{Administrar avances de ambiente escolar}.
    ...
    \UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUS 3}{Registrar avance de acciones de ambiente escolar} con la información referente a las acciones de la meta. 
    \UCpaso[\UCactor] Ingresa los datos requeridos en la pantalla \cdtIdRef{IUS 3}{Registrar avance de acciones de ambiente escolar}. \label{cus3:RegAvance}
    \UCpaso[\UCactor] Oprime el botón \cdtButton{Aceptar} en la pantalla \cdtIdRef{IUS 3}{Registrar avance de acciones de ambiente escolar}. \refTray{D}.
    \UCpaso[\UCsist] Verifica que la escuela se encuentre en estado ``Avance en edición''. \refTray{A}.
    \UCpaso[\UCsist] Verifica que la fecha actual se encuentre dentro del periodo definido por la SMAGEM para registrar avances. \refTray{E}.
...
\begin{UCtrayectoriaA}[Fin del caso de uso]{A}{El seguimiento no se encuentra en un estado que permita registrar avance en las acciones.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG28}{Operación no permitida por estado de la entidad} en la pantalla \cdtIdRef{IUS 2}{Administrar avances de ambiente escolar} indicando al actor que no puede registrar avance para la acción debido a que el seguimiento no se encuentra en estado ``Edición''. 
\end{UCtrayectoriaA}
 
    \begin{UCtrayectoriaA}{B}{El actor ingresó un tipo de dato incorrecto.}    
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG6}{Formato incorrecto} en la pantalla \cdtIdRef{IUS 3}{Registrar avance de acciones de ambiente escolar} indicando que el registro del avance para la acción no puede realizarse debido a que la información ingresada no es correcta.
    ...
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG7}{Se ha excedido la longitud máxima del campo} en la pantalla \cdtIdRef{IUS 3}{Registrar avance de acciones de ambiente escolar} indicando que el registro de los avances no puede realizarse debido a que la longitud del campo excede la longitud máxima definida.
    \UCpaso[] Continúa con el paso \ref{cus3:RegAvance} de la trayectoria principal.     
    \end{UCtrayectoriaA}
 
    \begin{UCtrayectoriaA}{D}{El actor desea cancelar la operación.}
      \UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \cdtButton{Cancelar} en la pantalla \cdtIdRef{IUS 3}{Registrar avance de acciones de ambiente escolar}.
    ...
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG41}{Acción fuera del periodo} en la pantalla \cdtIdRef{IUS 2}{Administrar avances de ambiente escolar} indicando al actor que no puede registrar avances debido a que la fecha actual se encuentra fuera del periodo definido por la SMAGEM para realizar la acción. 
    \end{UCtrayectoriaA}