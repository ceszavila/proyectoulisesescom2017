...
\begin{UseCase}{CUIBR 4}{Eliminar residuo sólido}
    {
...
% 	% OBSERVACIONES: Liste los cambios que debe realizar el Analista.
 	\UCccitem{Observaciones}{
 		\begin{UClist}
 			...
 			\RCitem{PC1}{\TOCHK{Postcondición: esta mal la postcondición, es de otro caso de uso}}{Fecha de entrega}
 			\RCitem{PC2}{\TOCHK{Precondición, tomar en cuenta el estado de Edición}}{Fecha de entrega}
 			\RCitem{PC3}{\TOCHK{Trayectoria principal, paso 3, dice: Eliminar integrante de línea de acción, si tiene que ser el MSG31}}{Fecha de entrega}
 		\end{UClist}		
 	}
% %--------------------------------------------------------
    ...
    \UCitem{Salidas}{
	\begin{UClist}
	    \UCli \cdtIdRef{MSG31}{Confirmar eliminación:} Se muestra en la pantalla emergente \cdtIdRef{IUIBR 4}{Eliminar residuo sólido} para que el actor confirme la eliminación del residuo sólido. 
	\end{UClist}
    }
...
\end{UseCase}
 ...
 \begin{UCtrayectoria}
    \UCpaso[\UCactor] Solicita eliminar un residuo sólido oprimiendo el botón \botKo del registro correspondiente en la pantalla \cdtIdRef{IUIBR 1}{Administrar información base para indicadores de residuos sólidos}.
    ...
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación realizada exitosamente} en la pantalla \cdtIdRef{IUIBR 1}{Administrar información base para indicadores de residuos sólidos} para indicar al actor que el registro del residuo sólido se ha eliminado exitosamente. 
